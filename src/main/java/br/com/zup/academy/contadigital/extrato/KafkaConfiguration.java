...
public class KafkaConfiguration {
    ...
    @Bean
    public ConsumerFactory<String, MensagemKafka> transactionConsumerFactory() {
        StringDeserializer stringDeserializer = new StringDeserializer();
        JsonDeserializer<MensagemKafka> jsonDeserializer = new JsonDeserializer<>(MensagemKafka.class, false);
    ...
    public ConcurrentKafkaListenerContainerFactory<String, MensagemKafka> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, MensagemKafka> factory = new ConcurrentKafkaListenerContainerFactory<>();
